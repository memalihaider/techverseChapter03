"use strict";(()=>{var e={};e.id=6182,e.ids=[6182],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},84770:e=>{e.exports=require("crypto")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},68621:e=>{e.exports=require("punycode")},76162:e=>{e.exports=require("stream")},17360:e=>{e.exports=require("url")},71568:e=>{e.exports=require("zlib")},75154:(e,r,t)=>{t.r(r),t.d(r,{originalPathname:()=>m,patchFetch:()=>v,requestAsyncStorage:()=>u,routeModule:()=>c,serverHooks:()=>h,staticGenerationAsyncStorage:()=>g});var a={};t.r(a),t.d(a,{POST:()=>l});var o=t(49303),i=t(88716),n=t(60670),s=t(87070),p=t(3360),d=t(86685);async function l(e,{params:r}){try{let t=e.cookies.get("admin_session")?.value;if(!t)return s.NextResponse.json({error:"Unauthorized"},{status:401});let{id:a}=r,o=JSON.parse(Buffer.from(t,"base64").toString()),{data:i,error:n}=await p.pR.from("registrations").select("*").eq("id",a).single();if(n||!i)return s.NextResponse.json({error:"Registration not found"},{status:404});let l=`CERT-${i.registration_number}-${new Date().getFullYear()}`,{error:c}=await p.pR.from("registrations").update({status:"approved",approval_date:new Date().toISOString(),approved_by:o.id,certificate_id:l}).eq("id",a);if(c)return console.error("Error updating registration:",c),s.NextResponse.json({error:"Failed to approve registration"},{status:500});let u=(0,d.BK)(i.team_name,i.team_leader_name,i.registration_number,l);return await (0,d.Cz)(i.team_leader_email,u.subject,u.body,a,"approval"),s.NextResponse.json({success:!0,message:"Registration approved and email sent",certificateId:l})}catch(e){return console.error("Approve registration error:",e),s.NextResponse.json({error:"An error occurred"},{status:500})}}let c=new o.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/admin/registrations/[id]/approve/route",pathname:"/api/admin/registrations/[id]/approve",filename:"route",bundlePath:"app/api/admin/registrations/[id]/approve/route"},resolvedPagePath:"/Users/macbookpro/Personal Work/tecverse03/app/api/admin/registrations/[id]/approve/route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:u,staticGenerationAsyncStorage:g,serverHooks:h}=c,m="/api/admin/registrations/[id]/approve/route";function v(){return(0,n.patchFetch)({serverHooks:h,staticGenerationAsyncStorage:g})}},3360:(e,r,t)=>{t.d(r,{ag:()=>d,pR:()=>n,v9:()=>p});var a=t(43974),o=t(42023);let i=process.env.SUPABASE_SERVICE_ROLE_KEY,n=(0,a.eI)("https://xplcgqfweqzliiwchmqw.supabase.co",i);async function s(e,r){return o.compare(e,r)}async function p(e,r){try{let{data:t,error:a}=await n.from("admin_users").select("*").eq("email",e).eq("is_active",!0).single();if(a||!t||!await s(r,t.password_hash))return null;await n.from("admin_users").update({last_login:new Date().toISOString()}).eq("id",t.id);let{password_hash:o,...i}=t;return i}catch(e){return console.error("Authentication error:",e),null}}async function d(e,r,t,a=null,o=null,i=null){try{await n.from("activity_logs").insert({admin_id:e,action:r,table_name:t,record_id:a,old_values:o,new_values:i})}catch(e){console.error("Activity log error:",e)}}},86685:(e,r,t)=>{t.d(r,{BK:()=>i,Cz:()=>o,xK:()=>n});var a=t(3360);async function o(e,r,t,o,i){try{return await a.pR.from("email_logs").insert({registration_id:o,email_type:i||"general",recipient_email:e,subject:r,body:t,status:"sent",sent_at:new Date().toISOString()}),console.log(`Email would be sent to ${e}: ${r}`),!0}catch(n){console.error("Email send error:",n);try{await a.pR.from("email_logs").insert({registration_id:o,email_type:i||"general",recipient_email:e,subject:r,body:t,status:"failed",error_message:n instanceof Error?n.message:"Unknown error"})}catch(e){console.error("Email log error:",e)}return!1}}function i(e,r,t,a){return{subject:`🎉 Registration Approved - Techverse 2026`,body:`
<!DOCTYPE html>
<html>
<head>
  <style>
...
<body>
  <div class="container">
    ...
    `}}}};var r=require("../../../../../../webpack-runtime.js");r.C(e);var t=e=>r(r.s=e),a=r.X(0,[8948,5972,3974,2023],()=>t(75154));module.exports=a})();